...
public class Adapter_professor_course_history extends RecyclerView.Adapter<Adapter_professor_course_history.ViewHolder>  {
    ...
    Adapter_professor_course_history(Context context, FirebaseDatabase db, String id, List<String> name) {
