...
public class Adapter_professor_course_history_student extends RecyclerView.Adapter<Adapter_professor_course_history_student.ViewHolder>  {
    ...
    private List<Integer> activity_pos;

    Adapter_professor_course_history_student(Context context, FirebaseDatabase db, String id, List<String> name, List<Integer> pos) {
